...
GLOBAL_LIST_INIT(wing_section_prefs, list(WING_NEST, WING_BACKSTREET, WING_UNKNOWN))

GLOBAL_LIST_INIT(district_prefs, list(WING_A, WING_B, WING_C, WING_D, WING_E, WING_F, WING_G,
		WING_H, WING_I, WING_J, WING_K, WING_L, WING_M, WING_N, WING_O, WING_P, WING_Q, WING_R, WING_S,
		WING_T, WING_U, WING_V, WING_W, WING_X, WING_Y, WING_Z, WING_UNKNOWN))
...
GLOBAL_LIST_INIT(agent_depts_prefs, sortList(list("None", "Control", "Command", "Training", "Information", "Safety", "Disciplinary", "Welfare", "Extraction", "Record")))

GLOBAL_LIST_INIT(allowed_client_languages, list(CLIENT_LANGUAGE_ENGLISH, CLIENT_LANGUAGE_RUSSIAN))
